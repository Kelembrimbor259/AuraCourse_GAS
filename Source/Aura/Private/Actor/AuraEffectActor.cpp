...
void AAuraEffectActor::ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectsClass)
{
	...
	const FGameplayEffectSpecHandle EffectSpecHandle = TargetAbilitySystemComponent->MakeOutgoingSpec(GameplayEffectsClass, ActorLevel, EffectContextHandle);
	...
	*/
	...
	if (EffectSpecHandle.Data->Def->DurationPolicy == EGameplayEffectDurationType::Infinite && InfiniteEffectRemovalPolicy == EEffectRemovalPolicy::RemoveOnEndOverlap)
	{
...
void AAuraEffectActor::OnOverlap(AActor* TargetActor)
{
	...
	if (bDestroyOnEffectRemoval == true)
	{
		Destroy();
	}
}
...
void AAuraEffectActor::RemoveInfiniteEffects(AActor* TargetActor)
{
	const auto UID = TargetActor->GetUniqueID();
